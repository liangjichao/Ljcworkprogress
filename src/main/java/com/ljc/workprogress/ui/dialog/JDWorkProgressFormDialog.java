...
import com.ljc.workprogress.domain.dto.WpsSaveDto;
import com.ljc.workprogress.enums.WorkProgressStatusEnum;
import com.ljc.workprogress.ui.JDIconButton;
import com.ljc.workprogress.ui.calendar.WpsDatePicker;
import com.ljc.workprogress.ui.editor.WpsMarkdownEditor;
import com.ljc.workprogress.ui.panel.WorkProgressPanel;
import com.ljc.workprogress.util.DateComputeUtils;
...
public class JDWorkProgressFormDialog extends DialogWrapper {
    ...
    private JButton createDayCopyButton() {
        JButton dayCopyBtn = new JDIconButton(LjcworkprogressIcons.COPY);
